  ...
  <tr><td align="center">
    <table width="100%" style="max-width:520px;background:#ffffff;border-radius:24px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.18);">
      <tr><td style="padding:36px 32px 28px;">
        <p style="margin:0 0 8px;font-size:13px;font-weight:700;letter-spacing:0.14em;text-transform:uppercase;color:#a4161a;">Game Goat 🎁</p>
        ${content}
        <p style="margin:32px 0 0;font-size:12px;color:#94a3b8;border-top:1px solid #f1f5f9;padding-top:20px;">
          ...
          <a href="https://games.xmasgoat.com" style="color:#0f5132;">games.xmasgoat.com</a>.
        </p>
      </td></tr>
    </table>
  </td></tr>
...
export function partyNightEmail(opts: {
  ...
  return base(`
    ...
    ${ctaButton(opts.joinUrl, "Open Game Goat →")}
  `);
}
